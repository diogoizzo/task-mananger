      ...
      <Menu>
         ...
         <section className="bg-white p-8 text-indigo-900 sticky top-0 z-30 shadow-md ">
            <div className="flex flex-wrap items-center -m-2">
               <div className="w-full flex flex-col md:w-2/3 p-2">
                  ...
                  <div className="flex font-medium text-indigo-90 mt-2 border-y-[1px] border-indigo-50 py-4">
                     <div className="w-full md:w-1/3  ">
                        {`Data da criação: ${dayjs(
                           activeProject?.createdAt
                        ).format('DD/MM/YYYY')}`}
                     </div>
                     <div className="w-full md:w-1/3 text-center">
                        {`Data de inicio: ${dayjs(
                           activeProject?.startDate
                        ).format('DD/MM/YYYY')}`}
                     </div>
                     <div className="w-full md:w-1/3 text-right">
                        {`Prazo para conclusão: ${dayjs(
               ...
               <div className="w-full flex  md:w-1/3">
                  <div className="flex flex-col space-y-3 w-9/12 mx-auto items-center ">
                     <BtnAdd onClick={openModal} text="Adicionar Tarefa" />
                     <BtnAdd
                        onClick={() => {
